...
export class PiecesController {
  ...
  @Post()
  async createPiece(@Param('tourId', new ValidateObjectId()) tourId, @Body() createPieceDTO: PieceDto, @Res() res) {
  ...
  @Get()
  async getPieces(@Param('tourId', new ValidateObjectId()) tourId, @Res() res) {
