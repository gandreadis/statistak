...
const CACHE = {
  ...
  'SELECT * FROM stuk': [{
    ...
    'metSolistKlarinet': 0,
    'metSolistZang': 0
  }, {'id': 7, 'titel': 'Lezginka', 'componist': 'M. Ippolitov-Ivanov', 'code': '07', 'metSolistKlarinet': 0, 'metSolistZang': 0}, {
    'id': 8,
    'titel': 'Sachidao',
    ...
    'metSolistKlarinet': 0,
    'metSolistZang': 0
  }, {'id': 18, 'titel': 'Onleesbaar 3', 'componist': 'W. Breuker', 'code': '17', 'metSolistKlarinet': 0, 'metSolistZang': 0}, {
    'id': 19,
    'titel': 'Kancheliade',
    ...
    'metSolistKlarinet': 0,
    'metSolistZang': 0
  }, {'id': 31, 'titel': 'Oopsala', 'componist': 'G. Kramers', 'code': 'L', 'metSolistKlarinet': 0, 'metSolistZang': 0}, {
    'id': 32,
    ...
    'metSolistKlarinet': 0,
    'metSolistZang': 0
  }, {'id': 36, 'titel': 'Georgisch Volkslied', 'componist': '', 'code': 'V', 'metSolistKlarinet': 0, 'metSolistZang': 0}],
  ...
  '\n    SELECT AVG(solist) AS percentage FROM\n    (SELECT MAX(stuk.metSolistZang) AS solist FROM optreden_repertoire\n    JOIN optreden ON optreden.id = optredenId\n    JOIN stuk ON stuk.id = stukId\n    \n    GROUP BY optredenId)': [{'percentage': 0.43636363636363634}],
